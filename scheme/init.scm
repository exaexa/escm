...
;  ***
;
; Basic scripts and some standards for exa-scheme.
; taken from TinySCHEME 1.38, made by dsouflis@acm.org
;
; TODO. I should check out how the big guys handle exceptions.
;
;  ***
...
; by [exa], defstruct from t-y-scheme
...
; TODO. add some object classes: standard-class, create-class, make-instance,...
